...
namespace test {
	...
	m_time(0), m_speed(2.0f)
	{
		...
		Square.SetPositionVertices(pos);
		...
		Square.m_shader->SetUniform1i("u_texture", 0);
	}
	...
	void MovingSquaresTest::OnRender() {
		...
		Square.m_shader->Bind();
		Square.m_texture->Bind();
...

		{
			...
			Square.m_shader->SetUniformMat4f("u_mvp", mvp);

			// Draw call
			// m_renderer.Draw(*m_VAO, *m_IBO, *m_shader);

			m_renderer.Draw(*Square.m_VAO, *Square.m_IBO, *Square.m_shader);
		}
